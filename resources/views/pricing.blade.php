...
@section('content')
    ...
    <section class="relative pt-36 pb-24 bg-ink overflow-hidden">
        ...
        <div class="absolute top-1/3 left-1/4 w-96 h-96 rounded-full blur-[120px] opacity-20" style="background:#16A34A">
        </div>
        <div class="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full blur-[100px] opacity-15"
            style="background:#7C3AED"></div>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <span
                class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-6 reveal">Pricing</span>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-20">
        ...
        <section class="mb-24">
            <div class="text-center mb-14 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Plans</span>
                <h2 class="font-black text-4xl sm:text-5xl text-ink mb-5 leading-tight">Monthly Membership <span
                        class="text-primary">Plans</span></h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">Pick the tier that fits your child's
                    interests. All plans include premium facilitation and Edfrica quality standards.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
                {{-- Explorer --}}
                <div
                    class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow duration-300 p-6 sm:p-8 flex flex-col reveal">
                    <div class="mb-6">
                    ...
                    <a href="{{ route('register') }}"
                        class="block w-full text-center py-3.5 rounded-xl font-black text-sm border-2 border-gray-200 text-ink hover:border-primary hover:text-primary transition-all duration-200">
                        Choose Plan
                    </a>
                </div>
                ...
                {{-- Builder (Featured) --}}
                <div
                    class="bg-white rounded-2xl border-2 border-primary shadow-xl shadow-primary/10 p-6 sm:p-8 flex flex-col relative reveal md:scale-[1.02]">
                    <div
                        class="absolute -top-4 left-1/2 -translate-x-1/2 bg-primary text-white text-xs font-black uppercase tracking-wider px-4 py-1.5 rounded-full whitespace-nowrap">
                        Most Popular</div>
                    <div class="mb-6">
                    ...
                    <a href="{{ route('register') }}"
                        class="block w-full text-center py-3.5 rounded-xl font-black text-sm bg-primary text-white hover:bg-primary/90 transition-all duration-200 shadow-lg shadow-primary/25">
                        Choose Plan
                    </a>
                </div>
                ...
                <div
                    ...
                    <a href="{{ route('register') }}"
                        class="block w-full text-center py-3.5 rounded-xl font-black text-sm border-2 border-accent text-accent hover:bg-accent hover:text-white transition-all duration-200">
                        Choose Plan
                    </a>
                </div>
            </div>
        ...
        <section class="mb-24 max-w-4xl mx-auto">
            <div class="text-center mb-12 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Registration</span>
                <h2 class="font-black text-3xl sm:text-4xl text-ink mb-4">One-Time Registration Fee</h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">Every new member pays an annual registration
                    fee that covers their welcome kit, student ID, and first-day readiness. Renewing members pay a reduced
                    loyalty rate.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 reveal">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 sm:p-6 text-center">
                    ...
                    <ul class="mt-4 text-xs text-muted space-y-1.5 text-left">
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> Welcome kit + ID card</li>
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> TLab T-shirt + journal</li>
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> Demo Day VIP pass</li>
                    </ul>
                </div>
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 sm:p-6 text-center">
                    ...
                    <ul class="mt-4 text-xs text-muted space-y-1.5 text-left">
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> Full welcome kit included</li>
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> 10% sibling discount applied</li>
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> Coordinated session scheduling</li>
                    </ul>
                </div>
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 sm:p-6 text-center">
                    ...
                    <ul class="mt-4 text-xs text-muted space-y-1.5 text-left">
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> Updated journal + badge</li>
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> Returning member ceremony</li>
                        <li class="flex items-start gap-2"><svg class="w-3 h-3 text-primary mt-0.5 flex-shrink-0"
                                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" />
                            </svg> &#8358;6,000 savings vs new member</li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="mb-24 max-w-5xl mx-auto">
            <div class="text-center mb-12 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Save
                    More</span>
                <h2 class="font-black text-3xl sm:text-4xl text-ink mb-4">Termly &amp; Annual Payment Options</h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">Pay ahead and save. Commitment is rewarded
                    with significant discounts.</p>
            </div>
            <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm reveal">
                <table class="w-full text-sm min-w-[600px]">
                    <thead>
                        <tr class="bg-gray-50">
                            <th class="text-left px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Payment
                                Cycle</th>
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Explorer
                            </th>
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Builder
                            </th>
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">
                                All-Access</th>
                            <th class="text-right px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Saving
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-4 font-bold text-ink">Termly <span
                                    class="text-muted font-semibold text-xs">(3 months)</span></td>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-6 py-4 font-bold text-ink">Annual <span
                                    class="text-muted font-semibold text-xs">(12 months)</span></td>
        ...
        <section class="mb-24 max-w-5xl mx-auto">
            <div class="text-center mb-12 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Discounts</span>
                <h2 class="font-black text-3xl sm:text-4xl text-ink mb-4">Discounts &amp; Special Access</h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">We believe every child deserves access.
                    Here's how we make it more affordable.</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 reveal">
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="text-xs text-muted font-semibold mb-3">10% off monthly subscription for every additional
                        child from the same family.</div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="text-xs text-muted font-semibold mb-3">5+ children from the same school join together — each
                        family gets a group discount.</div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="text-xs text-muted font-semibold mb-3">Refer a friend. When their child completes their
                        first month, you receive account credit.</div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
                    ...
                    <div class="text-xs text-muted font-semibold mb-3">5% of all slots reserved for children who qualify by
                        need and merit. Screened each intake.</div>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="text-xs text-muted font-semibold mb-3">Employers sponsor memberships for their teams'
                        children. Billed quarterly to the company.</div>
        ...
        <section class="mb-24 max-w-5xl mx-auto">
            <div class="text-center mb-12 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Corporate</span>
                <h2 class="font-black text-3xl sm:text-4xl text-ink mb-4">Corporate Family Plan</h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">Minimum 5 children per company. Billed
                    annually or quarterly.</p>
            </div>
            <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm reveal">
                <table class="w-full text-sm min-w-[500px]">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Clubs
                            </th>
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Annual
                                per Child</th>
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Quarterly
                            </th>
                            <th class="text-right px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">vs. Retail
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
        ...
        <section class="mb-24 max-w-5xl mx-auto">
            <div class="text-center mb-12 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Cohorts</span>
                <h2 class="font-black text-3xl sm:text-4xl text-ink mb-4">Techiecity</h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">Short-term, on-site cohort programmes for
                    specialised tech skills.</p>
            </div>
            <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm reveal">
                <table class="w-full text-sm min-w-[500px]">
                    <thead>
                        <tr class="bg-gray-50">
                            <th class="text-left px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Programme
                            </th>
                            <th class="text-center px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Duration
                            </th>
                            <th
                                class="text-left px-6 py-4 font-black text-ink text-xs uppercase tracking-wider hidden md:table-cell">
                                Best For</th>
                            <th class="text-right px-6 py-4 font-black text-ink text-xs uppercase tracking-wider">Pricing
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
        ...
        <section class="mb-24 max-w-5xl mx-auto">
            <div class="text-center mb-12 reveal">
                <span
                    class="inline-block bg-primary/10 text-primary text-xs font-black uppercase tracking-widest px-5 py-2 rounded-full mb-5">Short
                    Courses</span>
                <h2 class="font-black text-3xl sm:text-4xl text-ink mb-4">Short Courses</h2>
                <p class="text-muted font-semibold text-base max-w-2xl mx-auto">Focused, affordable courses for quick skill
                    acquisition.</p>
            </div>
            <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm reveal">
                <table class="w-full text-sm min-w-[500px]">
